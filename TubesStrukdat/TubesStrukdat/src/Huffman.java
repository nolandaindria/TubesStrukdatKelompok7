...
public class Huffman {  // Written by: Yancy Vance Paredes, October 17, 2013 edited by Peri,Slamet,Recsa
    ...
    public static void main(String[] args) throws FileNotFoundException {
    	...
    	System.out.println("Type the full path where you located your file");
    	String t4file=input.next();
    ...
    // This method assumes that the tree and dictionary uare already built
